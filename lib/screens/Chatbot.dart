...
//             ///botButtonIcon : ('P0_IMAGE_URL')+'assets/images/chat3.png',
...
//   ''';
  ...
  void loadLocalJs() async{
    final Js = await rootBundle.loadString('assets/settings-chatbot.js');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Return to App"),
        backgroundColor: Color(0xFF37393c),
        actions: [
        ],
      ),
      body:  WebViewPlus(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl: 'assets/settings-chatbot.js',
